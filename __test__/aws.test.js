...
const TEST_EVENT = require('./aws.event');
const event = new Event(TEST_EVENT).aws();
...
test ('Record value from AWS event', () => {
    expect(event.getRecords()).toEqual(TEST_EVENT.Records);
})
